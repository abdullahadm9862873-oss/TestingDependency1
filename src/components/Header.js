...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        A Full-Stack Engineer with a deep interest in Artificial Intelligence, system design, and intelligent automation. I focus on combining AI models with robust web architectures to build smart agents, data-driven platforms, and scalable infrastructure. Currently supporting startups in embedding AI into their core products and workflows.
      </div>
      <div
        className={`contentContainer ${
